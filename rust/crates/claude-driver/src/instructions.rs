...
//!
//! Verbatim port of `adapters/claude/session/instructions.ts` — this text is
//! a behavioral contract with the agent; keep byte-identical with the TS
//! implementation when editing either side.

pub const APPENDED_INSTRUCTIONS: &str = r#"
# Branch Naming
