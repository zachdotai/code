...
interface FloatingNewLoopButtonProps {
  onPress: () => void;
}

/**
 * Pill-shaped FAB anchored to the bottom-right corner — mirrors
 * FloatingNewAutomationButton so the two tabs feel like siblings.
 */
export function FloatingNewLoopButton({ onPress }: FloatingNewLoopButtonProps) {
