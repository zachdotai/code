...
import { CommandCenterSessionView } from "@posthog/ui/features/command-center/components/CommandCenterSessionView";
...
export function HogletDetailPanel({ hoglet, onClose }: HogletDetailPanelProps) {
  ...
  const archiveKeys = useArchiveCacheKeys();
  ...
  const handleRetire = async () => {
    ...
    try {
      ...
      await archiveTaskImperative(hoglet.taskId, queryClient, archiveKeys, {
        skipNavigate: true,
      });
    } catch (error) {
